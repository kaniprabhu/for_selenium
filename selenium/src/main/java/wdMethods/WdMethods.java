...
public interface WdMethods {
		...
		/**
		 * This method will click the element and without take snap
		 * @param ele   - The Webelement (button/link/element) to be clicked
		 * @author Babu - TestLeaf
		 */
		...
		/**
		 * This method will clear the previous content from the element and take snap
		 * @param ele   - The Webelement content is cleared
		 * @author Babu - TestLeaf
		 */
		...
		/**
		 * This method will get the title and return the title of the page
		 * @param ele   - The Webelement (button/link/element) in which title of the page to be retrieved
		 * @author Babu - TestLeaf
		 */
